...
class Main(QtWidgets.QMainWindow):
    def __init__(
        ...
        # self.tracks_widget.setBackgroundColor(QtGui.QColor("red"))
        # self.tracks_widget.setStyleSheet("background-color: yellow;")
        ...
        file_load = QAction('Open2...', menubar)
        ...
        # signals
        # where we can findout more about the track items
    ...
    def _change_track(self):
        ...
        message.setText("This is a message using pyside2")
        message.exec_()
